...
const RajoriGardenSeoAgencyDelhi = () => {
  ...
  return (
    <>
      <Helmet>
        <title>SEO Service Agency in Rajori Garden Delhi | DPM IT Solutions - Top SEO Company</title>
        <meta name="description" content="Leading SEO Agency in Rajori Garden Delhi - DPM IT Solutions offers professional SEO services, organic ranking, keyword research, technical SEO & link building. Get 300%+ traffic growth. Call now!" />
        <meta name="keywords" content="SEO agency Rajori Garden, SEO services Rajori Garden Delhi, best SEO company Rajori Garden, search engine optimization Rajori Garden, SEO expert Rajori Garden, organic SEO services, local SEO Rajori Garden, technical SEO services, link building services, keyword research Rajori Garden, DPM IT Solutions, top SEO agency Delhi" />
        
        {/* Open Graph Tags */}
        <meta property="og:title" content="Best SEO Service Agency in Rajori Garden Delhi | DPM IT Solutions" />
        <meta property="og:description" content="Professional SEO services in Rajori Garden Delhi. Drive organic traffic, improve rankings & boost ROI with data-driven SEO strategies. 10+ years experience." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.dpmitsolutions.com/rajori-garden-delhi/seo-service-agency" />
        <meta property="og:image" content="https://www.dpmitsolutions.com/assets/seoajency.webp" />
        
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Best SEO Service Agency in Rajori Garden Delhi | DPM IT Solutions" />
        <meta name="twitter:description" content="Leading SEO agency in Rajori Garden Delhi offering professional search engine optimization services. Increase organic traffic by 300%+." />
        ...
        <link rel="canonical" href="https://www.dpmitsolutions.com/rajori-garden-delhi/seo-service-agency" />
          ...
          {`
            {
              ...
              "description": "Leading SEO Service Agency in Rajori Garden Delhi offering professional search engine optimization services",
              "url": "https://www.dpmitsolutions.com/rajori-garden-delhi/seo-service-agency",
              "address": {
                "@type": "PostalAddress",
          ...
          <div className="relative z-20 flex flex-col items-center justify-center h-full text-white px-4">
            ...
            <div className="relative mb-8">
              <h1 className="text-4xl md:text-6xl font-black bg-gradient-to-r from-white via-cyan-200 to-purple-300 bg-clip-text text-transparent tracking-tight leading-tight text-center">
                SEO Service Agency in Rajori Garden Delhi
              </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="relative overflow-hidden rounded-3xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500">
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = '<div class="w-full h-80 bg-white border-2 border-gray-200 rounded-lg shadow-lg flex items-center justify-center"><div class="text-center"><div class="text-4xl mb-4">DPM IT Solutions</div><p class="text-gray-600">SEO Services Agency Rajori Garden</p></div></div>';
                      }}
                    />
              ...
              <div className="order-1 lg:order-2 animate-on-scroll slide-from-right">
                <h2 className="text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">
                  Rajori Garden's Leading <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">SEO Service Agency</span> for Business Growth
                </h2>
                <h3 className="text-2xl font-bold text-gray-700 mb-4">
                  DPM IT Solutions - Certified SEO Experts in Rajori Garden
                </h3>
                ...
                <div className="relative group">
                  ...
                  <div className="relative overflow-hidden rounded-3xl shadow-2xl transform group-hover:scale-105 transition-transform duration-500">
                    <img 
                      ...
                      alt="SEO Strategy Services Rajori Garden Delhi - Organic Search Optimization" 
                      className="w-full h-98 object-cover"
                      onError={(e) => {
                        e.target.style.display = 'none';
                        e.target.parentElement.innerHTML = '<div class="w-full h-80 bg-white border-2 border-gray-200 rounded-lg shadow-lg flex items-center justify-center"><div class="text-center"><div class="text-4xl mb-4">SEO Strategy</div><p class="text-gray-600">DPM IT Solutions Rajori Garden</p></div></div>';
                      }}
                    />
          ...
          <div className="max-w-7xl mx-auto px-4 relative">
            <div className="text-center mb-16 animate-on-scroll slide-from-bottom">
              ...
              <h3 className="text-2xl font-bold text-blue-200 mb-4">
                End-to-End SEO Solutions by DPM IT Solutions Rajori Garden
              </h3>
              <p className="text-lg text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Comprehensive SEO solutions designed to dominate search engine rankings and drive continuous organic growth for your Rajori Garden business.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 relative">
            <div className="text-center mb-12 animate-on-scroll slide-from-bottom">
              ...
              <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
                See how Rajori Garden businesses achieved remarkable growth through our proven SEO strategies and expertise.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  business: "E-commerce Store Rajori Garden",
        ...
        <section className="py-10 bg-white relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 relative">
            <div className="text-center mb-12 animate-on-scroll slide-from-bottom">
              ...
              <h3 className="text-2xl font-bold text-gray-700 mb-4">
                Why Leading Brands in Rajori Garden Choose DPM IT Solutions for SEO
              </h3>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-stretch">
              ...
              <div className="animate-on-scroll slide-from-left flex flex-col justify-between h-full">
                <div className="space-y-6">
                  {[
                    {
                      title: "Proven SEO Expertise in Rajori Garden",
                  ...
                  <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-6 rounded-3xl shadow-2xl">
                    ...
                    <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl p-6">
                      ...
                      <p className="text-center text-gray-600 mb-6 font-medium">
                        Start Your SEO Campaign with DPM IT Solutions Rajori Garden!
                      </p>
...
export default RajoriGardenSeoAgencyDelhi;